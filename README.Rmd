...
See the following vignettes to learn how to use DoHACpalletws with other packages:
...
The DoHAC palettte includes primary colours green, orange, grey. These are supported by light and dark shades.

```{r echo=FALSE, out.height="30px",out.width="120px"}
library(dohactheme)
plot(dohac_colours)
```
